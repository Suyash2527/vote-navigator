...
import { Vote, Mail, Lock, Eye, EyeOff, ArrowRight, Loader2 } from "lucide-react";
      ...
      >
        ...
        <div className="text-center mb-8">
          <motion.div
            ...
            className="w-16 h-16 rounded-2xl bg-primary/20 flex items-center justify-center mx-auto mb-4 glow-primary"
          >
            <Vote className="w-8 h-8 text-primary" />
          </motion.div>
          <h1 className="text-3xl font-bold gradient-text mb-2">Welcome back</h1>
          <p className="text-foreground/60">Sign in to continue your civic journey</p>
        </div>
        ...
        <div className="glass rounded-2xl p-8 space-y-5">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs text-muted-foreground">
              <span className="bg-card px-3 py-0.5 rounded-full">or continue with email</span>
            </div>
          </div>
